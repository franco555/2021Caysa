...
class ScReceivedReport extends StatefulWidget {
  @override
  _ScReceivedReportState createState() => _ScReceivedReportState();
}

class _ScReceivedReportState extends State<ScReceivedReport> {
