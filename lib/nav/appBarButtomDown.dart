...
import 'package:caysa2021/nav/appBarbuttonDownDetail.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return  PreferredSize(
      ...
      bottom:PreferredSize(
        ...
        child: Container(
          decoration: lineaHorizontalBottom(CFr().getColorTextNavBar(),CFr().getColorFondo()),
          padding:  EdgeInsets.symmetric(vertical: 10, horizontal: 10),
          width: size.width,
          child: AppBarButtomDownDetail(tituloSc: tituloNav, subTituloSc:subTituloNav, total:total, fecha: "Fecha: 10/12/12",))
        ),
      ),      
    );
  }
